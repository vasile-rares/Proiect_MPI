        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WordsPerMinute = table.Column<decimal>(type: "numeric", nullable: false),
                    RawWordsPerMinute = table.Column<decimal>(type: "numeric", nullable: false),
                    Accuracy = table.Column<decimal>(type: "numeric", nullable: false),
                    Consistency = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HighestWordsPerMinute = table.Column<decimal>(type: "numeric", nullable: false),
                    AverageWordsPerMinute = table.Column<decimal>(type: "numeric", nullable: false),
                    HighestRawWordsPerMinute = table.Column<decimal>(type: "numeric", nullable: false),
                    AverageRawWordsPerMinute = table.Column<decimal>(type: "numeric", nullable: false),
                    HighestAccuracy = table.Column<decimal>(type: "numeric", nullable: false),
                    AverageAccuracy = table.Column<decimal>(type: "numeric", nullable: false),
                    HighestConsistency = table.Column<decimal>(type: "numeric", nullable: false),
                    AverageConsistency = table.Column<decimal>(type: "numeric", nullable: false),
